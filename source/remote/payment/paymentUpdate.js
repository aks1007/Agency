...
function showAllItems()
{
    ...
    .then(data =>
    {
        ...
        {            
            gO[j] = Number(data.PaymentBill[j].grA)   
            gN[j] = Number(data.PaymentBill[j].grA)
...
function setBill(num)
{
    ...
    {        
        ...
        document.getElementById('ba'+num).value = Number(testO[num]) + Number(document.getElementById('grA'+num).value)
