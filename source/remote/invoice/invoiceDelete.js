...
document.getElementById('submitButton').addEventListener('click', (event) => {
    ...
    if(req==0)
    {
        ...
        //Update Notice
        fetch('http://localhost:7070/invoice/basic/'+ serialNo.value, { method: 'DELETE'})
        ...
        .then(data => {
            ...
            {                
                ...
                setTimeout(function(){ x.className = x.className.replace("showMessage", "");location.reload()}, 3000);
            }
            else
            {
                var x = document.getElementById("snackbar");
