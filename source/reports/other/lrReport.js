...
//----------------------------------------------------------WHEN PARTY 'A' VALUE IS CHANGE ENABLE/DISABLE CUSTOMER/CUSTOMER GROUP SELECT
...
//----------------------------------------------------------WHEN PARTY 'B' VALUE IS CHANGE ENABLE/DISABLE SUPPLIER/SUPPLIER GROUP SELECT
...
//----------------------------------------------------------WHEN PARTY 'C' VALUE IS CHANGE ENABLE/DISABLE TRANSPORTER SELECT
