function followRow()
{
    ...
    sessionStorage.setItem('marketKey',this.cells[1].innerText)
    x = sessionStorage.getItem('marketKey')
    console.log(x)
...
function showDatabase()
{
    ...
    .then(data => 
    {
        ...
        for(i=0; i<limit; i++)
        {
            ...
            element2.innerHTML = data.Market[rowCount-1].market
...
document.getElementById('back').onclick = () => { 
    ...
    if(y==null)
    {            
        window.location = "./marketHome.html"
    }
}
