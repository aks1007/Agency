function followRow()
{
    sessionStorage.setItem('mailKey',this.cells[0].innerText)
...
function enterRow()
{
    this.addEventListener("keydown", function(event)
    {
        ...
        {
            sessionStorage.setItem('mailKey',this.cells[0].innerText)
            x = sessionStorage.getItem('mailKey')
            window.location = './mailUpdate.html'
        }
    })
}
...
function filteredData()
{
    ...
    console.log(dt)
    fetch("http://localhost:7070/mail/range/from="+dateFrom.value+"&to="+dt)
