function followRow()
{
    sessionStorage.setItem('paymentKey',this.cells[0].innerText)
...
function enterRow()
{
    this.addEventListener("keydown", function(event)
    {
        ...
        {
            sessionStorage.setItem('paymentKey',this.cells[0].innerText)
            x = sessionStorage.getItem('paymentKey')
            window.location = './paymentUpdate.html'
        }
    })
}
...
function filteredData()
{
    ...
    fetch("http://localhost:7070/payment/range/from="+dateFrom.value+"&to="+dt)
    ...
    .then(data =>
    {
        ...
        {        
            ...
            var cell6 = row.insertCell(6)
            var element7 = document.createElement("span")
            element7.innerHTML = "₹" + data.Payment[rowCount-1].ta
            element7.style.textAlign = "centre"
            cell6.appendChild(element7);

            var cell7 = row.insertCell(7)
            var element8 = document.createElement("span")
            element8.innerHTML = data.Payment[rowCount-1].brokP + "%"
            element8.style.textAlign = "centre"
            cell7.appendChild(element8);

            var cell8 = row.insertCell(8)
            var element9 = document.createElement("span")
            element9.innerHTML = "₹" + data.Payment[rowCount-1].brok
            element9.style.textAlign = "centre"
            cell8.appendChild(element9);
