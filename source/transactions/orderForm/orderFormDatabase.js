function followRow()
{
    sessionStorage.setItem('orderFormKey',this.cells[0].innerText)
...
function enterRow()
{
    this.addEventListener("keydown", function(event)
    {
        ...
        {
            sessionStorage.setItem('orderFormKey',this.cells[0].innerText)
            x = sessionStorage.getItem('orderFormKey')
            window.location = './orderFormUpdate.html'
        }
    })
}
...
function filteredData()
{
    ...
    console.log(dt)
    fetch("http://localhost:7070/orderForm/range/from="+dateFrom.value+"&to="+dt)
